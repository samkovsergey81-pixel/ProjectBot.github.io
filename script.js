...
const knowledgeBase = {
    ...
    'виды ботов': 'Существует несколько видов ботов:\n Чат-боты — для общения и поддержки\n Спам боты — для рассылки рекламы\n Поисковые роботы — индексируют сайты\n Игровые боты — имитируют игроков',
...
function addMessage(text, isUser = false) {
    ...
    contentDiv.innerHTML = text.replace(/\n/g, '<br>'); // Используем innerHTML для поддержки <br>
