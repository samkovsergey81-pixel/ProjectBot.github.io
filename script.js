...
const knowledgeBase = {
    ...
    'виды ботов': 'Существует несколько видов ботов:<br>• <strong>Чат-боты</strong> — для общения и поддержки<br>• <strong>Спам боты</strong> — для рассылки рекламы<br>• <strong>Поисковые роботы</strong> — индексируют сайты<br>• <strong>Игровые боты</strong> — имитируют игроков<br>• <strong>',
